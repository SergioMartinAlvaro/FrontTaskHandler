...
const AddTask = () => {
  ...
  const fieldsConfigAddTaskToAll: IFieldConfig[] = [
    ...
    },
    {
      type: "select",
      name: "userImplicated",
      placeholder: "Usuario Implicado",
      onChange: (e) => changeUserImplicated(e),
      options: options,
    },
  ];
  ...
  const fieldsConfig: IFieldConfig[] = [
    ...
    },
    {
      ...
      name: "userAssigned",
      placeholder: "Usuario Implicado",
      onChange: (e) => changeUserAssigned(e),
      options: options,
    },
  ];
  ...
  return (
    <div className="addTask">
      <div className="addTask__titleContainer">
        {value ? (
          <h2 className="addTask__title">Añadir tarea</h2>
        ) : (
          <h2 className="addTask__title">Añadir a todos</h2>
        )}
      </div>
      <Form
        fields={value ? fieldsConfig : fieldsConfigAddTaskToAll}
        submitAction={async () => await handleSubmit()}
      ></Form>
    </div>
  );
};
